...
* link:lab1/docs/lab1-instructions.adoc[Exercise 2 - Production Deployments to OpenShift using WildFly Swarm]
* link:lab1/docs/lab1-instructions.adoc[Exercise 3 - Microservice features for Health checks and Configuration Management]
* link:lab1/docs/lab1-instructions.adoc[Exercise 4 - Additional Fraction features with Swagger and Flyway]